            ...
            <div class="p-6 bg-white border-b border-gray-200 sm:px-10">
                <div class="flex flex-col items-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-10">
                    <div class="flex justify-center w-full sm:w-1/4 sm:justify-start">
                        @if ($user->image)
                            <img class="w-24 h-24 rounded-full" src="{{ asset('storage/images/' . $user->image) }}"
                                alt="Profile Picture" />
                        @else
                    ...
                    <div class="flex flex-col justify-center sm:w-3/4">
                        ...
                        <p
                            class="px-3 py-2 mx-auto mt-2 text-sm text-center text-gray-500 border border-black rounded-md w-fit">
                            {{ $user->role . ' ' . $user->nama }}</p>
