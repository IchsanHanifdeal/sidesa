<x-app-layout>
    <div class="flex flex-col min-h-screen">
        <form method="POST" enctype="multipart/form-data" action="{{ route('register-warga.store') }}"
            ...
            <div>
                <label class="block mb-1 font-semibold text-gray-600" for="name">Nama Pengguna
            ...
            <div>
                <label class="block mb-1 font-semibold text-gray-600" for="nik">NIK
                    <span class="text-red-500">*</span>
                </label>
            ...
            <div>
                <label class="block mb-1 font-semibold text-gray-600" for="alamat">Alamat
                    <span class="text-red-500">*</span>
                </label>
                <input type="text" required name="alamat" id="alamat" placeholder="Masukkan Alamat"
                    class="input bg-[#c2d7ec] input-bordered w-full" value="{{ old('alamat') }}" />
                @error('alamat')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                <label class="block mb-1 font-semibold text-gray-600" for="no_hp">No Handphone
                    <span class="text-red-500">*</span>
                </label>
                <input type="text" required name="no_hp" id="no_hp" placeholder="Masukkan No Handphone"
                    class="input bg-[#c2d7ec] input-bordered w-full" value="{{ old('no_hp') }}" />
                @error('no_hp')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div>
                <label class="block mb-1 font-semibold text-gray-600" for="id_desa">Pilih Desa
                    <span class="text-red-500">*</span>
                </label>
            ...
            <div>
                <label class="block mb-1 font-semibold text-gray-600" for="password">Kata Sandi
                    <span class="text-red-500">*</span>
                </label>
            ...
            <div>
                <label class="block mb-1 font-semibold text-gray-600" for="password_confirmation">Konfirmasi Kata Sandi
                    <span class="text-red-500">*</span>
                </label>
            ...
            <div>
                <label class="block mb-1 font-semibold text-gray-600" for="fileInput">Upload Gambar
                    <span class="text-red-500">*</span>
                </label>
                <input type="file" name="image" id="fileInput" class="w-full file-input" />
                @error('image')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            ...
            <button type="submit" class="w-full px-3 py-2 mx-auto text-white border-none btn bg-custom-blue">
                DAFTAR
            </button>
        </form>
